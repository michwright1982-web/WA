...
export default function WorkflowsPage() {
  ...
  const handleSelectNode = (node: FlowNode) => {
    ...
    setConfigFlowHeader(c.flowHeader || '');
    setConfigFlowBody(c.flowBody || '');
    setConfigFlowFooter(c.flowFooter || '');
    setConfigFlowId(c.flowId || '');
    setConfigFlowCta(c.flowCta || 'Open Form');
    setConfigFlowScreen(c.flowScreen || '');
